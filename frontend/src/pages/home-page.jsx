      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Raza Webs Solution provides professional web development and design services to help businesses grow online with innovative, user-friendly, and SEO-focused solutions.",
